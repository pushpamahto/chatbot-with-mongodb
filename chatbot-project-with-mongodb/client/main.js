...
// Handle User Info Form Submission-----> with email exist 


// userEmailInput.addEventListener('input', () => {
//     const emailError = document.getElementById("email-error");
    
//     // When user starts typing again after error
...
//             userEmailInput.style.borderColor = "#ff0000";
//             userEmailInput.focus();
//         } else {
...
userInfoForm.addEventListener("submit", (e) => {
    ...
    // Always proceed to chat, don't wait for backend response
    document.body.classList.remove("show-user-form");
    document.body.classList.add("show-chatbot");
    userNameInput.value = "";
    userEmailInput.value = "";
